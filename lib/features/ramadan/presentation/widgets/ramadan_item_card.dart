...
class RamadanItemCard extends StatefulWidget {
  final int index;
  final String title;
  final String content;
  final VoidCallback onTap;

  const RamadanItemCard({
    super.key,
    required this.index,
    required this.title,
  ...
  @override
  State<RamadanItemCard> createState() => _RamadanItemCardState();
}

class _RamadanItemCardState extends State<RamadanItemCard> {
